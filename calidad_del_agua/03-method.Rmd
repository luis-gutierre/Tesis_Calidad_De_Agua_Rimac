...
```{r}
library(readxl)
datosc <- read_excel("data_media_fx_meses.xlsx")
...
Se observa que 22  variables  sus coeficientes de pearson es alto, es decir las variables 
...
es decir las variables se encuentran  poco correlacionados con las demas variables.


El autor de la tesis aplico una prueba no parametrica basado en el coeficiente de "sperman"
(cuadro 5,pdf),esta es mas adecuada cuando las variables son tipo escala ordinal.
...
#Por otro lado el indicador "kmo" es igual 0.5 
...
En los meses de Marzo y febrero esta asociado a las variables(As,)
